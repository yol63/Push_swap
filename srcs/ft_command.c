...
/*   Updated: 2020/09/19 14:30:14 by romarash         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_command(int* stack1, int* stack2,char const *command)
{
    ...
    else if(ft_strcmp(command,"ra") == 0 || ft_strcmp(command,"rb") == 0 || ft_strcmp(command,"rr") == 0 )
        ft_command_r(stack1,stack2,command);
    else if(ft_strcmp(command,"rra") == 0 || ft_strcmp(command,"rrb") == 0 || ft_strcmp(command,"rrr") == 0 )
